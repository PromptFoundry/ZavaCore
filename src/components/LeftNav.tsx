            ...
            <div className="flex flex-col gap-1 px-3">
              ...
              >
                ...
                <div className={`flex items-center flex-1 h-9 rounded-[12px] transition-colors ${
                  ...
                  <span className="text-sm text-[#242424]">Component Library</span>
                </div>
              </div>
              ...
              >
                {(selectedItem === 'sharepoint' || location.pathname === '/sharepoint') && (
                  <div className="w-[3px] h-4 bg-[#464FEB] rounded-full shrink-0" />
                )}
                <div className={`flex items-center flex-1 h-9 rounded-[12px] transition-colors ${
                  selectedItem === 'sharepoint' || location.pathname === '/sharepoint'
                  ...
                  <svg className="w-5 h-5 mr-[9px] shrink-0 text-[#424242]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.6 9h16.8M3.6 15h16.8M12 3a13.5 13.5 0 010 18M12 3a13.5 13.5 0 000 18" />
                  </svg>
